...
public class MainActivity extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener, FragmentRecomendaciones.OnFragmentInteractionListener, FragmentLosPoints.OnFragmentInteractionListener {

    private ApiService myApiService;
    private TextView myResponseTextView;
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_recomendaciones) {
            ...
            fragment = new FragmentRecomendaciones();
            fragmentTransaction = true;
        } else if (id == R.id.nav_losPoints) {
            fragment = new FragmentLosPoints();
            fragmentTransaction = true;
